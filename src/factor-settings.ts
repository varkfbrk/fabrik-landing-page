export default {
   ...
   */
  site: {
    logo: require("./static/color-logo@3x.png"),
    logoInverse: require("./static/color-logo@3x.png"),
    nav: [
      {
        _item: "home",
        path: "/",
  ...
  home: {
    intro: {
      title: "Simplify the adoption of augmented reality and virtual reality for enterprises",
      content:
        "Fabrik works with enterprises to leverage immersive technologies and achieve business excellence across verticals.",
      buttons: [
        {
          _item: "contact",
          link: "/contact",
